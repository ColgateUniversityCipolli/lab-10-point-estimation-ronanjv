...
```{r}
# altbinom of .5 theta
prob.5 = daltbinom(6, 11, 0.5, 0.5)
# altbinom of 1.5 theta
prob1.5 = daltbinom(6, 11, 0.5, 1.5)
prob.5
prob1.5
...
```{r}
#| label: theta.5_1.5
#| fig-cap: "Altham's Binomial PMF for Theta = 0.5 and 1.5"
#| fig-width: 5
#| fig-height: 3
#| scale: "80%"
#| fig-align: "center"
...
# plotting .5 theta PMF
plot1 = ggplot() +
geom_linerange(data = ggdat, aes(x = x, ymin = 0, ymax = theta0.5)) + geom_hline(yintercept = 0) +
...
# plotting 1.5 theta PMF
plot2 = ggplot() +
geom_linerange(data = ggdat, aes(x = x, ymin = 0, ymax = theta1.5)) + geom_hline(yintercept = 0) +
scale_x_continuous("x", breaks = 0:11) +
ylab("Probability") +
ggtitle(" = 1.50") +
theme_bw()
